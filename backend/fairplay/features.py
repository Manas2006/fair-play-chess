    ...
    timeline = [
        {
            ...
            "move_san": str(getattr(row, "move_san", row.move_uci)),
            "best_move": str(row.best_move_uci),
            "best_move_san": str(getattr(row, "best_move_san", row.best_move_uci)),
            "fen_before": str(getattr(row, "fen_before", "")),
            "fen_after": str(getattr(row, "fen_after", "")),
            "eval_cp": round(float(getattr(row, "eval_cp", 0.0)), 1),
            "player_color": str(getattr(row, "player_color", "white")),
